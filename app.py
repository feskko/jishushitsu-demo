...
def generate_mock_data():
   ...
   mock_students = [
        ("佐藤 健太", "高3"), ("鈴木 優子", "高3"), ("高橋 拓海", "高3"), ("田中 美咲", "高3"),
        ...
        ("野村 誠", "高3"), ("今井 恵", "高3"), ("高木 翔", "高3"), ("川口 遥", "高3"),
        ("松田 健", "高2"), ("原田 栞", "高2"), ("小川 翼", "高2"), ("竹内 舞", "高2"),
        ("中川 亮", "高1"), ("小野 恵理", "高1"), ("田村 駿", "高1"), ("金子 紬", "高1"),
        ("和田 豪", "中3"), ("中山 玲奈", "中3"), ("石田 勇気", "中3"), ("上田 瞳", "中3"),
        ("川上 匠", "中2"), ("福田 杏奈", "中2"), ("小島 仁", "中2"), ("柴田 綾", "中2"),
        ("宮崎 聡", "中1"), ("内田 華", "中1"), ("西村 浩", "中1"), ("菊池 唯", "中1"),
        ("千葉 剛", "小6"), ("小田 梨花", "小6"), ("菅原 健", "小6"), ("三浦 萌", "小6"),
        ("中野 誠", "小5"), ("大野 咲", "小5"), ("藤井 徹", "小5"), ("金子 遥", "小5"),
        ("岡本 豪", "小4"), ("菅野 恵", "小4"), ("平野 翔", "小4"), ("高田 舞", "小4"),
        ("沢田 亮", "高2"), ("酒井 玲奈", "高2"), ("原 駿", "高1"), ("高野 瞳", "高1"),
        ("浅野 匠", "中3"), ("大橋 杏奈", "中3"), ("安藤 仁", "中2"), ("村田 綾", "中2")
    ]
    for i in range(366):
